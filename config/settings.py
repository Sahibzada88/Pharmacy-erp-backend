...
# CORS
# -------------------------------------------------------------------
_cors_origins_raw = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000', cast=Csv())

if len(_cors_origins_raw) == 1 and _cors_origins_raw[0].strip() == '*':
    # Development convenience: CORS_ALLOWED_ORIGINS=* in .env allows any origin.
    # Do NOT use this in production — set explicit origins instead
