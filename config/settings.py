...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'pharmacy-erp-backend-sepia.vercel.app',
    'pharmacy-erp-backend-5j0c49ycd.vercel.app',
    '.vercel.app',  # Wildcard trusts ALL subdomains generated by Vercel
]
# -------------------------------------------------------------------
# Applications
# -------------------------------------------------------------------
...
CSRF_TRUSTED_ORIGINS = [
    "https://*.vercel.app",  # Wildcard trusts any frontend Vercel layout preview link
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
# -------------------------------------------------------------------
